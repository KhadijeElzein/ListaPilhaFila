...
import br.com.khadije.zein.service.interfaces.ListaEstaticaService;

public class ListaEstaticaServiceImpl<T extends Comparable<T>> implements ListaEstaticaService<T> {
