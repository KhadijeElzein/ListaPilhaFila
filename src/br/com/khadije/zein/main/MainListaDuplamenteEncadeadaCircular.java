...
import br.com.khadije.zein.domain.listas.ListaDuplamenteEncadeadaCircular;

public class MainListaDuplamenteEncadeadaCircular {
	public static void main(String[] args) {
		ListaDuplamenteEncadeadaCircular<Integer> lde1 = new ListaDuplamenteEncadeadaCircular<Integer>();
		ListaDuplamenteEncadeadaCircular<Integer> lde2 = new ListaDuplamenteEncadeadaCircular<Integer>();
		ListaDuplamenteEncadeadaCircular<Integer> lde3 = new ListaDuplamenteEncadeadaCircular<Integer>();
