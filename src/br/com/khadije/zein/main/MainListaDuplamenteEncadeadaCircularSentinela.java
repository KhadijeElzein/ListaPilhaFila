...
import br.com.khadije.zein.domain.listas.ListaDuplamenteEncadeadaCircularSentinela;

public class MainListaDuplamenteEncadeadaCircularSentinela {
	public static void main(String[] args) {
		ListaDuplamenteEncadeadaCircularSentinela<Integer> lde1 = new ListaDuplamenteEncadeadaCircularSentinela<Integer>();
		ListaDuplamenteEncadeadaCircularSentinela<Integer> lde2 = new ListaDuplamenteEncadeadaCircularSentinela<Integer>();
		ListaDuplamenteEncadeadaCircularSentinela<Integer> lde3 = new ListaDuplamenteEncadeadaCircularSentinela<Integer>();
